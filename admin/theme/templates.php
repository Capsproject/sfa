            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>admin/announcement/index.php" ><i class="fa fa-calendar fa-fw"></i>  Announcement</a>
                        ...
                        ?>
                         <li>
                             <a href="<?php echo web_root; ?>admin/enrollees/index.php" ><i class="fa fa-user fa-fw"></i>  New Students
                             <label class="label pull-right label-primary"><?php echo isset($enrollees->enrollees) ? $enrollees->enrollees : 0; ?></label> </a>
                             
                        </li>
                        <?php }  ?>
                        <li>
                             <a href="<?php echo web_root; ?>admin/subject/index.php" ><i class="fa  fa-book     fa-fw"></i>  Subject </a>
